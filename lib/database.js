...
function add_vote(count, reward, vote, cb) {
...
module.exports = {
  ...
  update_votes: function(cb) {
    Votes.collection.remove( function (err) {
      if (err) throw err;
      lib.get_blockcount(function (height) {
        for(var i = height - 20; i < height; i++) {
          lib.get_blockhash(i, function (hash) {
            lib.get_block(hash, function (block) {
              lib.get_vote(function (vote) {
                add_vote(block.height, block.reward, block.vote, function () {
                  if (i == height) {
                    return cb();
                  }
                });
